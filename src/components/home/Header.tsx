      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#F3F7F4]/85 backdrop-blur-md border-b border-[#004225]/10">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            {/* Desktop Navigation */}
            <nav className="hidden lg:flex items-center lg:gap-6 xl:gap-12 flex-1 justify-center h-full">
              {NAV_LINKS.map((link) => (
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div 
              ...
              className="fixed top-0 left-0 bottom-0 w-3/4 sm:w-1/2 bg-[#F3F7F4] z-[70] lg:hidden shadow-2xl flex flex-col"
            >
